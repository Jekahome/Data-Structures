...
fn main() {
    ...
    println!("LLRB average search time   :{} nanos", result_find.iter().sum::<u128>()/result_find.len() as u128);
    ...
    println!("Vec average search time    :{} millis", result_find.iter().sum::<u128>()/result_find.len() as u128);
}
