...
/// $ MIRIFLAGS="-Zmiri-tag-raw-pointers" cargo +nightly miri test rb_tree 
/// cargo test rb_tree 
#[cfg(test)]
mod tests {
    use super::RBTree;

    // cargo test red_black_tree::rb_tree::tests::test_remove_black_2_3_2_2_root_success   -- --nocapture
    #[test]
    fn test_remove_black_2_3_2_2_root_success() {
        ...
        tree.delete(&418);
        let s: Vec<i32> = tree.iter().map(|x| x.value).collect();
        println!("{:?}",s);
    }

    // cargo test red_black_tree::rb_tree::tests::find 
    // MIRIFLAGS="-Zmiri-tag-raw-pointers" cargo +nightly miri test red_black_tree::rb_tree::tests::find
    #[test]
    fn find() {
     ...
     // MIRIFLAGS="-Zmiri-tag-raw-pointers" cargo +nightly miri test red_black_tree::rb_tree::tests::insert
    #[test]
    fn insert() {
        let mut tree = RBTree::<usize, char>::new();
        for (k, v) in "hello, world!".chars().enumerate() {
    ...
    // MIRIFLAGS="-Zmiri-tag-raw-pointers" cargo +nightly miri test red_black_tree::rb_tree::tests::delete
    #[test]
    fn delete(){
        let mut tree = RBTree::<usize, char>::new();
        for (k, v) in "hello, world!".chars().enumerate() {
