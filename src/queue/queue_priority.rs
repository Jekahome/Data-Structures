...
mod ds_queue_priority{
    ...
    impl<T:std::cmp::PartialEq> QueuePriority<T>{
        pub fn new() -> Self {
            Self { queue_low: Vec::new(), queue_middle: Vec::new(), queue_high: Vec::new() }
        }
        ...
        pub fn change_priority(&mut self, find_item: T, find_priority: Priority, new_priority: Priority) -> bool{
            if !self.is_empty() {
